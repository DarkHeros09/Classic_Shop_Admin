  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.qtyInStock, qtyInStock) ||
                other.qtyInStock == qtyInStock) &&
            (identical(other.productImage1, productImage1) ||
                other.productImage1 == productImage1) &&
            (identical(other.productImage2, productImage2) ||
                other.productImage2 == productImage2) &&
            (identical(other.productImage3, productImage3) ||
                other.productImage3 == productImage3) &&
            (identical(other.size, size) || other.size == size) &&
            (identical(other.color, color) || other.color == color) &&
            (identical(other.price, price) || other.price == price) &&
            (identical(other.active, active) || other.active == active) &&
            (identical(other.parentProductActive, parentProductActive) ||
                other.parentProductActive == parentProductActive) &&
