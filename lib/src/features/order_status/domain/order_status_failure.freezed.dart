...
part of 'order_status_failure.dart';
...
/// @nodoc
abstract class $OrderStatusFailureCopyWith<$Res> {
  factory $OrderStatusFailureCopyWith(
          OrderStatusFailure value, $Res Function(OrderStatusFailure) then) =
      _$OrderStatusFailureCopyWithImpl<$Res, OrderStatusFailure>;
}

/// @nodoc
class _$OrderStatusFailureCopyWithImpl<$Res, $Val extends OrderStatusFailure>
    implements $OrderStatusFailureCopyWith<$Res> {
  _$OrderStatusFailureCopyWithImpl(this._value, this._then);
  ...
  /// Create a copy of OrderStatusFailure
...
class __$$ApiImplCopyWithImpl<$Res>
    extends _$OrderStatusFailureCopyWithImpl<$Res, _$ApiImpl>
...
class _$ApiImpl extends _Api {
  ...
  @override
  String toString() {
    return 'OrderStatusFailure.api(errorCode: $errorCode)';
  }
...
abstract class _Api extends OrderStatusFailure {
...
class __$$ServerImplCopyWithImpl<$Res>
    extends _$OrderStatusFailureCopyWithImpl<$Res, _$ServerImpl>
...
class _$ServerImpl extends _Server {
  ...
  @override
  String toString() {
    return 'OrderStatusFailure.server(message: $message)';
  }
...
abstract class _Server extends OrderStatusFailure {
