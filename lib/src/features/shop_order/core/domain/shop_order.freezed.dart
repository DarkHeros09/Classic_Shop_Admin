...
class _$ShopOrderImpl extends _ShopOrder {
  ...
  @override
  String toString() {
    return 'ShopOrder(id: $id, status: $status, itemCount: $itemCount, trackNumber: $trackNumber, orderNumber: $orderNumber, userId: $userId, username: $username, paymentTypeId: $paymentTypeId, shippingAddressId: $shippingAddressId, orderTotal: $orderTotal, shippingMethodId: $shippingMethodId, orderStatusId: $orderStatusId, totalCount: $totalCount, createdAt: $createdAt, updatedAt: $updatedAt, completedAt: $completedAt)';
  }
...
abstract class _ShopOrder extends ShopOrder {
  const factory _ShopOrder(
      ...
      required final DateTime completedAt}) = _$ShopOrderImpl;
