...
final class _$ProductItemApi extends ProductItemApi {
  _$ProductItemApi([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final Type definitionType = ProductItemApi;
...
// coverage:ignore-file
// ignore_for_file: type=lint
final class _$ProductItemAdminApi extends ProductItemAdminApi {
  _$ProductItemAdminApi([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final Type definitionType = ProductItemAdminApi;
  ...
  Future<Response<Map<String, dynamic>>> createProductItem({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.105:8080/admin/v1/admins/${adminId}/product-items');
    final $body = data;
    final Request $request = Request(
      'POST',
      $url,
  ...
  Future<Response<Map<String, dynamic>>> updateProductItem({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.105:8080/admin/v1/admins/${adminId}/product-items/${itemId}');
    final $body = data;
    final Request $request = Request(
      'PUT',
      $url,
