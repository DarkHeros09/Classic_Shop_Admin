...
import 'package:classic_shop_admin/src/features/category_promotion/add_category_promotion/application/add_category_promotion_notifier.dart';
...
class _AddCategoryPromotionPageState
  ...
  Widget build(BuildContext context) {
    ...
    ref
      ..listen(categoriesNotifierProvider, (previous, next) {
        next.map(
