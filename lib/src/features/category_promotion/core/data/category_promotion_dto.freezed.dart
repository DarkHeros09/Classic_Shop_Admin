...
class _$CategoryPromotionDTOImpl extends _CategoryPromotionDTO {
  ...
  @override
  String toString() {
    return 'CategoryPromotionDTO(categoryId: $categoryId, categoryName: $categoryName, promotionId: $promotionId, promotionName: $promotionName, categoryPromotionImage: $categoryPromotionImage, active: $active)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, categoryId, categoryName,
      promotionId, promotionName, categoryPromotionImage, active);
