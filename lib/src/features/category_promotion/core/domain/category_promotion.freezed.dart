...
class _$CategoryPromotionImpl implements _CategoryPromotion {
  ...
  @override
  String toString() {
    return 'CategoryPromotion(categoryId: $categoryId, categoryName: $categoryName, promotionId: $promotionId, promotionName: $promotionName, categoryPromotionImage: $categoryPromotionImage, active: $active)';
  }
