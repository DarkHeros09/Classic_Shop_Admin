...
class _$BrandPromotionImpl implements _BrandPromotion {
  ...
  @override
  String toString() {
    return 'BrandPromotion(brandId: $brandId, brandName: $brandName, promotionId: $promotionId, promotionName: $promotionName, brandPromotionImage: $brandPromotionImage, active: $active)';
  }
