...
import 'package:classic_shop_admin/src/features/size/core/data/size_extension.dart';
...
class SizeRepository {
  ...
  Future<Either<SizeFailure, Fresh<List<SizeModel>>>> fetchSizes() async {
    try {
  ...
  Future<Either<SizeFailure, Unit>> updateSize({
    required int adminId,
    required int productSizeId,
    required String size,
  }) async {
    try {
      final productImage = await _remoteService.updateSize(
        adminId: adminId,
