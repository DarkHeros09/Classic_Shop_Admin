...
class _$SizeModelImpl implements _SizeModel {
  const _$SizeModelImpl({required this.id, required this.sizeValue});
  ...
  @override
  String toString() {
    return 'SizeModel(id: $id, sizeValue: $sizeValue)';
  }
...
abstract class _SizeModel implements SizeModel {
  const factory _SizeModel(
      ...
      required final String sizeValue}) = _$SizeModelImpl;
