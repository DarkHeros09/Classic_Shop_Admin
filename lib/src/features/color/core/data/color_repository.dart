...
import 'package:classic_shop_admin/src/features/color/core/data/color_extension.dart';
...
class ColorRepository {
  ...
  Future<Either<ColorFailure, Fresh<List<ColorModel>>>> fetchColors() async {
    try {
  ...
  Future<Either<ColorFailure, Unit>> updateColor({
    required int adminId,
    required int productColorId,
    required String color,
  }) async {
    try {
      final productImage = await _remoteService.updateColor(
        adminId: adminId,
