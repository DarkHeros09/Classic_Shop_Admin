...
class _$ColorModelImpl implements _ColorModel {
  const _$ColorModelImpl({required this.id, required this.colorValue});
  ...
  @override
  String toString() {
    return 'ColorModel(id: $id, colorValue: $colorValue)';
  }
...
abstract class _ColorModel implements ColorModel {
  const factory _ColorModel(
      ...
      required final String colorValue}) = _$ColorModelImpl;
