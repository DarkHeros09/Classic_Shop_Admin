...
class _$DashboardImpl extends _Dashboard {
  ...
  @override
  String toString() {
    return 'Dashboard(activeProducts: $activeProducts, totalProducts: $totalProducts, activeUsers: $activeUsers, totalUsers: $totalUsers, activeOrders: $activeOrders, totalOrders: $totalOrders, dailyRevenue: $dailyRevenue, totalRevenue: $totalRevenue)';
  }
...
abstract class _Dashboard extends Dashboard {
  const factory _Dashboard(
      ...
      required final String dailyRevenue,
      required final int totalRevenue}) = _$DashboardImpl;
