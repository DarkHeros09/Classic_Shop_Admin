...
abstract class $DashboardDTOCopyWith<$Res> {
  factory $DashboardDTOCopyWith(
          DashboardDTO value, $Res Function(DashboardDTO) then) =
  ...
  $Res call(
      ...
      int totalOrders,
      String todayRevenue,
      @JsonKey(defaultValue: 0) int totalRevenue});
}
...
abstract class _$$DashboardDTOImplCopyWith<$Res>
  ...
  factory _$$DashboardDTOImplCopyWith(
          _$DashboardDTOImpl value, $Res Function(_$DashboardDTOImpl) then) =
...
/// @nodoc
@JsonSerializable()
class _$DashboardDTOImpl extends _DashboardDTO {
  const _$DashboardDTOImpl(
      ...
      @JsonKey(defaultValue: 0) required this.totalRevenue})
      : super._();
  ...
  @override
  String toString() {
    return 'DashboardDTO(activeProducts: $activeProducts, totalProducts: $totalProducts, activeUsers: $activeUsers, totalUsers: $totalUsers, activeOrders: $activeOrders, totalOrders: $totalOrders, todayRevenue: $todayRevenue, totalRevenue: $totalRevenue)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$DashboardDTOImplToJson(
      this,
    );
  }
}

abstract class _DashboardDTO extends DashboardDTO {
  const factory _DashboardDTO(
          ...
          required final String todayRevenue,
          @JsonKey(defaultValue: 0) required final int totalRevenue}) =
      _$DashboardDTOImpl;
  const _DashboardDTO._() : super._();
