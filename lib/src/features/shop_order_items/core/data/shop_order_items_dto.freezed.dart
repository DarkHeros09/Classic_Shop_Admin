...
ShopOrderItemsDTO _$ShopOrderItemsDTOFromJson(Map<String, dynamic> json) {
  return _ShopOrderItemsDTO.fromJson(json);
}

/// @nodoc
mixin _$ShopOrderItemsDTO {
...
/// @nodoc
abstract class $ShopOrderItemsDTOCopyWith<$Res> {
  factory $ShopOrderItemsDTOCopyWith(
          ShopOrderItemsDTO value, $Res Function(ShopOrderItemsDTO) then) =
      _$ShopOrderItemsDTOCopyWithImpl<$Res, ShopOrderItemsDTO>;
  @useResult
  $Res call(
      {int id,
      String status,
...
/// @nodoc
class _$ShopOrderItemsDTOCopyWithImpl<$Res, $Val extends ShopOrderItemsDTO>
    implements $ShopOrderItemsDTOCopyWith<$Res> {
  _$ShopOrderItemsDTOCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ShopOrderItemsDTOImplCopyWith<$Res>
    implements $ShopOrderItemsDTOCopyWith<$Res> {
  factory _$$ShopOrderItemsDTOImplCopyWith(_$ShopOrderItemsDTOImpl value,
          $Res Function(_$ShopOrderItemsDTOImpl) then) =
      __$$ShopOrderItemsDTOImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$ShopOrderItemsDTOImplCopyWithImpl<$Res>
    extends _$ShopOrderItemsDTOCopyWithImpl<$Res, _$ShopOrderItemsDTOImpl>
    implements _$$ShopOrderItemsDTOImplCopyWith<$Res> {
  __$$ShopOrderItemsDTOImplCopyWithImpl(_$ShopOrderItemsDTOImpl _value,
  ...
  $Res call({
    ...
    return _then(_$ShopOrderItemsDTOImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$ShopOrderItemsDTOImpl extends _ShopOrderItemsDTO {
  const _$ShopOrderItemsDTOImpl(
      {required this.id,
  ...
  factory _$ShopOrderItemsDTOImpl.fromJson(Map<String, dynamic> json) =>
      _$$ShopOrderItemsDTOImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ShopOrderItemsDTOImpl &&
  ...
  _$$ShopOrderItemsDTOImplCopyWith<_$ShopOrderItemsDTOImpl> get copyWith =>
      __$$ShopOrderItemsDTOImplCopyWithImpl<_$ShopOrderItemsDTOImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ShopOrderItemsDTOImplToJson(
      this,
    );
  }
}

abstract class _ShopOrderItemsDTO extends ShopOrderItemsDTO {
  const factory _ShopOrderItemsDTO(
      ...
      required final DateTime createdAt}) = _$ShopOrderItemsDTOImpl;
  const _ShopOrderItemsDTO._() : super._();

  factory _ShopOrderItemsDTO.fromJson(Map<String, dynamic> json) =
      _$ShopOrderItemsDTOImpl.fromJson;
