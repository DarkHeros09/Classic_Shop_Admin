...
class _$ProductPromotionDTOImpl extends _ProductPromotionDTO {
  ...
  @override
  String toString() {
    return 'ProductPromotionDTO(productId: $productId, productName: $productName, promotionId: $promotionId, promotionName: $promotionName, productPromotionImage: $productPromotionImage, active: $active)';
  }
